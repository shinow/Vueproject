<template>
  <div class="Paycode">
    <header>
      <img onclick="javascript:history.back(-1);" src="../../assets/img/fanhu.png" alt />
      <span>手势密码设置</span>
    </header>
    ...
    <div class="gesture_wrapper">
      <div class="thumbnail">
        ...
        <span class="limit" style="color:white">至少连接四个点</span>
        <span style="color:white" class="again againcn">再次绘制解锁图案</span>
        <span style="color:white" class="disagree disagreecn">两次不一致,请重新绘制</span>
      </div>
