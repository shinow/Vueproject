<template>
  <div>
    ...
    <div class="Co">
      <van-button type="primary" size="large">点击上传微信收款码</van-button>
      <van-uploader
      ...
      <div style="text-align: center" class="imll">
        ...
        <div style="margin-top:0.1rem" v-if="Tyimg">
          ...
          <van-radio-group @change="changeRo" v-model="Wcode">
            <van-radio style="float: left;margin:0.1rem 0 0 0.3rem;" name="1">微信个码</van-radio>
            <van-radio style="float: left;margin:0.1rem 0 0 0.2rem" name="4">微信商码</van-radio>
          </van-radio-group>
        </div>
