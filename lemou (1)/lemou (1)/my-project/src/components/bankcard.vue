  ...
  <div>
    ...
    <div class="content" v-for="(item,index) in dataK" :key="index">
      <div style="padding-top:0.22rem" class="name">
        ...
        <div class="Bjab" @click="tianjia(bian,item.id,item.userName,item.cardNo,item.bankName)">
...
.content {
  ...
  background: linear-gradient(
    -45deg,
    rgba(118, 165, 251, 1) 0%,
    rgba(119, 183, 253, 1) 100%
  );
...
.tianjia {
  ...
  margin-left: 0.25rem;
  line-height: 0.37rem;
  border: 0.01rem dashed rgba(81, 81, 81, 1);
