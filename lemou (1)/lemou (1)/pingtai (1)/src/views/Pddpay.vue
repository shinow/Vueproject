  ...
  <div class="Pddpay">
    <div class="dingdan">
      ...
      <el-input
        ...
        placeholder="请输入内容"
      ></el-input>
      <span style="margin-left:30px">经销商名称：</span>
      <el-input
        size="small"
        style="width:200px"
        @change="dealerTransaction()"
    ...
    <div class="details" style="margin:50px 0 0 0">
      ...
      >
        ...
        <el-table-column align="center" show-overflow-tooltip prop="pdduid" label="买家标识"></el-table-column>
    ...
    <!-- --------------------------------------------- -->
    <el-dialog :visible.sync="dialogVisible" @close="closeDio" width="80%">
      <span>状态：</span>
      <el-select
        style="width:160px"
        v-model="status"
...
<script>
import { pddUserlist, pddUserdelete, pddpayList } from "@/api";
export default {
  name: "Pddpay",
  data() {
    return {
  ...
  methods: {
    ...
    Linklist() {
      var par = {
        ...
        pageSize: this.size3,
        pid: this.RadioPay.id, //拼多多买家ID  (74   86) 8  (89)  3  31  34
